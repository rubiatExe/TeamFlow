...
4. Use the **Manager review guide** to see how many quoted résumé examples support the
...
7. If a technical reviewer asks about implementation, use this document and the
...
- Block-level cosine ranking and a documented 75/25 top-two evidence aggregation,
